...
$(document).ready(function() {
    ...
    let menuDom = ` <li class="nav-item  d-lg-block">
    <a href="../../pages/dashboard/dashboard.html" class="nav-link nav-link-style">
        <i class="fi fi-home"></i></a>
</li>
<li class="nav-item  d-lg-block">
    <a class="nav-link nav-link-style share-link">
        <i class="fi fi-share"></i></a>
</li>
...
<li class="nav-item  d-lg-block">
    <a href="../../pages/add/add.html" class="nav-link nav-link-style">
...
<li class="nav-item dropdown dropdown-user">
    ...
    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
        <a class="dropdown-item" href="../../index.html">
        <i class="fi fi-power"></i> Logout</a>
    </div>
</li>`;
    ...
    if (typeof(customerUrlid) != 'undefined' && customerUrlid) {
        ...
        menuDom = ` <li class="nav-item  d-lg-block"><a href="../../pages/dashboard/dashboard.html?customer=${customerUrlid}" 
        class="nav-link nav-link-style"><i class="fi fi-home"></i></a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" id="dropdown-flag" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="fi fi-nav-icon-a"></i>
        ...
        if (user[0].user_type == '1') {
            menuDom = ` <li class="nav-item  d-lg-block"><a href="../../pages/dashboard/dashboard.html" class="nav-link nav-link-style">
            <i class="fi fi-home"></i></a>
        </li>
            <li class="nav-item  d-lg-block"><a class="nav-link nav-link-style share-link"><i class="fi fi-share"></i></a>
            </li>
            <li class="nav-item  d-lg-block"><a href="../../pages/add/add.html" class="nav-link nav-link-style"><i class="fi fi-plus-a"></i></a>
            </li>
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="dropdown-flag" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <i class="fi fi-nav-icon-a"></i>
        ...
        <li class="nav-item dropdown dropdown-user">
            ...
            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                <a class="dropdown-item" href="../../index.html"><i class="fi fi-power"></i> Logout</a>
            </div>
        </li>`;
        }
